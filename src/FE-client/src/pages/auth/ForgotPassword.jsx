        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-500 to-indigo-600 p-12 flex-col justify-between text-white">
          <div>
            ...
            <div className="pt-8 border-t border-blue-400/30">
              ...
              <Link
                to="/login"
                className="inline-flex items-center space-x-2 text-white hover:text-blue-100 transition-colors cursor-pointer"
              >
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-100 rounded-full mb-4">
                ...
                {step === 2 && <KeyRound className="w-8 h-8 text-blue-600" />}
                {step === 3 && <Shield className="w-8 h-8 text-blue-600" />}
              </div>
              ...
              <p className="text-gray-600">
                {step === 1 &&
                  "Nhập email để nhận mã xác nhận 6 số qua email"}
                {step === 2 &&
            ...
            >
                  ...
                  <div className="flex justify-center gap-3 mb-4">
                    {[0, 1, 2, 3, 4, 5].map((index) => (
                      <input
                        ...
                        } rounded-lg focus:ring-2 focus:ring-blue-200 outline-none transition-all duration-200`}
                      />
                    ))}
                  </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 transition disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
              >
                {isLoading ? (
